...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/potential_map_multi_rmax.png}
	\caption{\textbf{Mass-split diagnostic for the truncated model.} The plot visualises the particle assignment across the truncation boundary and verifies that the inner particle component and the truncated outer mass sum to the original halo mass.}
	\label{fig:tnfw_validation_mass_split}
\end{figure}
