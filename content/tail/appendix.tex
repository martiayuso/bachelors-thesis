...
\begin{figure}[H]
	...
	\caption{Density profile evolution for the truncated-NFW experiment with cutoff at 5 kpc.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{content/ch5/img/0.5.png}
	\caption{Density profile evolution for the truncated-NFW experiment with cutoff at 0.5 kpc.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{content/ch5/img/0.05.png}
	\caption{Density profile evolution for the truncated-NFW experiment with cutoff at 0.05 kpc.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{content/ch5/img/0.03.png}
	\caption{Density profile evolution for the truncated-NFW experiment with cutoff at 0.03 kpc.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{content/ch5/img/0.02.png}
	\caption{Density profile evolution for the truncated-NFW experiment with cutoff at 0.02 kpc.}
\end{figure}