...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/orbit_02.png}
	\caption{\textbf{Example orbits crossing the truncation boundary.} Selected test particles that cross $R_{\mathrm{cut}}$ are shown to verify the hybrid treatment does not introduce noticeable integration artefacts on the tested timescale.}
	\label{fig:tnfw_validation_orbits}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/orbit_03.png}
	\caption{\textbf{Example orbits crossing the truncation boundary.} Selected test particles that cross $R_{\mathrm{cut}}$ are shown to verify the hybrid treatment does not introduce noticeable integration artefacts on the tested timescale.}
	\label{fig:tnfw_validation_orbits}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/orbit_04.png}
	\caption{\textbf{Example orbits crossing the truncation boundary.} Selected test particles that cross $R_{\mathrm{cut}}$ are shown to verify the hybrid treatment does not introduce noticeable integration artefacts on the tested timescale.}
	\label{fig:tnfw_validation_orbits}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/5.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/0.5.png}
	\caption{\textbf{Baseline evolution with ratio to the initial state.} The upper panel shows the density evolution over time. The lower panel shows the density ratio relative to the initial conditions.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/0.05.png}
	\caption{\textbf{Baseline evolution with ratio to the initial state.} The upper panel shows the density evolution over time. The lower panel shows the density ratio relative to the initial conditions.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/0.03.png}
	\caption{\textbf{Baseline evolution with ratio to the initial state.} The upper panel shows the density evolution over time. The lower panel shows the density ratio relative to the initial conditions.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{content/ch5/img/0.02.png}
	\caption{\textbf{Baseline evolution with ratio to the initial state.} The upper panel shows the density evolution over time. The lower panel shows the density ratio relative to the initial conditions.}
\end{figure}