...
In the collisionless limit, dark matter is described by a phase-space distribution function $f(\mathbf{x},\mathbf{v},t)$ that obeys the collisionless Boltzmann equation, coupled to Poisson's equation for the gravitational potential \cite{binney2008galactic}. The key implication is that halo evolution is governed by a smooth mean gravitational field rather than by direct microscopic collisions between particles.
