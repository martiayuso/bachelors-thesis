...
% Manual page geometry (preserved below for reference; commented out)
%\setlength{\textwidth}{146.8mm} % = 210mm - 31.6mm - 31.6mm
%\setlength{\oddsidemargin}{6.2mm} % 31.6mm - 1in (from hoffset)
%\setlength{\evensidemargin}{6.2mm} % 31.6mm - 1in (from hoffset) 
%\setlength{\topmargin}{-2.2mm} % = 0mm -1in + 23.2mm 
%\setlength{\textheight}{221.9mm} % = 297mm -29.5mm -31.6mm - 14mm (12 to accomodate footline with pagenumber)
%\setlength{\headheight}{14mm}
% Use geometry for consistent margin control; try 20mm side margins (original manual lengths preserved above)
\usepackage[a4paper,includehead,includefoot,left=27mm,right=27mm,top=28mm,bottom=28mm]{geometry}
\setlength{\headheight}{14mm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pagestyle{fancy}
  ...
  \fancyhead[L]{\bfseries \nouppercase{\ifodd\value{page}\rightmark\else\leftmark\fi}}
  \fancyhead[R]{}
  \fancyfoot[C]{\thepage}
