...
def plot(ic_file, sim_files, labels):
    ...
    # ax1.axvline(0.05, color='gray', linestyle='--')

    plt.tight_layout()
    plt.savefig("density_evo_10.png", dpi=300)
    plt.show()
...
if __name__ == "__main__":
    ...
    sims = [
        "profile_snapshot_0002.hdf5.npz",
        "profile_snapshot_0004.hdf5.npz",
        "profile_snapshot_0006.hdf5.npz",
        "profile_snapshot_0008.hdf5.npz",
        "profile_snapshot_0010.hdf5.npz"
    ]
    labels = ["2 Gyr", "4 Gyr", "6 Gyr", "8 Gyr", "10 Gyr"]
