...
if __name__ == "__main__":
    ...
    labels = [
        r"$\epsilon_{\mathrm{fmm}} = 0.1$, 10 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.01$, 10 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.001$, 10 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.0001$, 10 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.1$, 100 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.01$, 100 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.001$, 100 Gyr",
        r"$\epsilon_{\mathrm{fmm}} = 0.0001$, 100 Gyr",
    ]
