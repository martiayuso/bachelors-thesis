...
def plot(ic_file, sim_files, labels):
    ...
    ax1.set_title(r"$\theta_{cr}$ Study, Density Profile Evolution for $\epsilon = 0.01\ \mathrm{kpc}$")
    ...
    plt.savefig("density_evo_theta_cr.png", dpi=300, bbox_inches="tight", pad_inches=0.02)
    plt.show()
