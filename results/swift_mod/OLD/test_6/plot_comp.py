...
if __name__ == "__main__":
    ...
    sims = [
        "profile_snapshot_orig_0070.hdf5.npz",
        "profile_snapshot_mod_0030.hdf5.npz",
        "profile_snapshot_mod_0050.hdf5.npz",
        "profile_snapshot_mod_0070.hdf5.npz"
    ]

    labels = [
        "orig 70", "swift mod 30", "swift mod 50", "swift mod 70"
    ]
