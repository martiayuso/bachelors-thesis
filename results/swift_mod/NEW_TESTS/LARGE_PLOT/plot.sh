...
BASE_DIR="/home/marti-ayuso/uni/bachelors_thesis/bachelors-thesis/results/swift_mod/NEW_TESTS/LARGE_PLOT"

# Loop through all subfolders
for DIR in "$BASE_DIR"/Rcut*/; do
