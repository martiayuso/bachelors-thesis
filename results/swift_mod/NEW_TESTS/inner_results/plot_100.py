...
def plot(sim_files, labels):
    ...
    ax1.set_title(
        r"Density Profiles for Different $R_{\rm cut}$ and $\epsilon = 0.01\ \mathrm{kpc}$, at 100 Gyr",
        pad = 20
    )
...
if __name__ == "__main__":
    ...
    sims = [
        ...
        "test18/profile_chunk_0995_0999.hdf5.npz",
        "test17/profile_chunk_0995_0999.hdf5.npz",
        "test14/profile_chunk_0995_0999.hdf5.npz",
        "test16/profile_chunk_0995_0999.hdf5.npz",
        "test8/profile_chunk_0995_0999.hdf5.npz",
        "test15/profile_chunk_0995_0999.hdf5.npz",
