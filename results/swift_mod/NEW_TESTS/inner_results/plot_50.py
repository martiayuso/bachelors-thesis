...
def plot(sim_files, labels):
    ...
    # ------------------------------------------------------------------
    colors = cm.rainbow(np.linspace(0, 1, len(sim_files)))
    ...
    ax1.set_title(
        r"Density Profiles for Different $R_{\rm cut}$ and $\epsilon = 0.01\ \mathrm{kpc}$, at 50 Gyr",
        pad = 20
    )
...
if __name__ == "__main__":
    ...
    sims = [
        ...
        "test18/profile_chunk_0500_0504.hdf5.npz",
        "test17/profile_chunk_0500_0504.hdf5.npz",
        "test14/profile_chunk_0500_0504.hdf5.npz",
        "test16/profile_chunk_0500_0504.hdf5.npz",
        "test8/profile_chunk_0500_0504.hdf5.npz",
        "test15/profile_chunk_0500_0504.hdf5.npz",
    ...
    labels = [
        r"$R_{\rm cut} = 1.0\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.5\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.1\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.09\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.08\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.07\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.06\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.05\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.04\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.03\ \mathrm{kpc}$",
        r"$R_{\rm cut} = 0.02\ \mathrm{kpc}$"
    ]
